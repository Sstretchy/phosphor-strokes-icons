...
export const GrainsSlash = createIcon("grains-slash", [
  [
    "path",
    {
  ...
  [
    "path",
    {
      d: "M11.4618 11.6077C10.5156 12.7322 9.99777 14.1552 10 15.6249V17.4999C10.9129 17.5006 11.8148 17.3011 12.6422 16.9153C13.4695 16.5295 14.2021 15.9669 14.7883 15.267",
      stroke: "currentColor",
      strokeLinecap: "round",
      strokeLinejoin: "round"
    }
