...
export const UserRectangle = createIcon("user-rectangle", [
  [
    "path",
    {
      d: "M4.69531 16.25C5.08247 15.1523 5.80061 14.2018 6.75069 13.5295C7.70081 12.8572 8.83606 12.4961 10 12.4961C11.1639 12.4961 12.2992 12.8572 13.2493 13.5295C14.1994 14.2018 14.9175 15.1523 15.3047 16.25",
      stroke: "currentColor",
      strokeLinecap: "round",
