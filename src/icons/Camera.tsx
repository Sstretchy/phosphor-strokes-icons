...
export const Camera = createIcon("camera", [
  ...
  [
    "path",
    {
      d: "M10 13.125C11.5533 13.125 12.8125 11.8658 12.8125 10.3125C12.8125 8.75919 11.5533 7.5 10 7.5C8.44669 7.5 7.1875 8.75919 7.1875 10.3125C7.1875 11.8658 8.44669 13.125 10 13.125Z",
      stroke: "currentColor",
      strokeLinecap: "round",
      strokeLinejoin: "round"
    }
