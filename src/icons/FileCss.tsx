...
export const FileCss = createIcon("file-css", [
  ...
  [
    "path",
    {
      d: "M25.4874 19.1999C25.4874 19.1999 21.8087 18.2274 21.5124 20.5749C21.2162 22.9224 26.3162 21.8399 25.9849 24.4149C25.6762 26.8099 22.0124 25.7899 22.0124 25.7899",
      stroke: "currentColor",
      strokeLinecap: "round",
      strokeLinejoin: "round"
    }
