...
export const BehanceLogo = createIcon("behance-logo", [
  [
    "path",
    {
      d: "M4 15.5H11.75C12.8772 15.5 13.9582 15.9478 14.7552 16.7448C15.5522 17.5418 16 18.6228 16 19.75C16 20.8772 15.5522 21.9582 14.7552 22.7552C13.9582 23.5522 12.8772 24 11.75 24H4V8H11.25C12.2446 8 13.1984 8.39509 13.9017 9.09835C14.6049 9.80161 15 10.7554 15 11.75C15 12.7446 14.6049 13.6984 13.9017 14.4017C13.1984 15.1049 12.2446 15.5 11.25 15.5",
      stroke: "currentColor",
      strokeLinecap: "round",
