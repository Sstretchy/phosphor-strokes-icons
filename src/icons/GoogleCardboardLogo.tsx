...
export const GoogleCardboardLogo = createIcon("google-cardboard-logo", [
  ...
  [
    "path",
    {
      d: "M6.25 11.875C7.28556 11.875 8.125 11.0356 8.125 10C8.125 8.96444 7.28556 8.125 6.25 8.125C5.21447 8.125 4.375 8.96444 4.375 10C4.375 11.0356 5.21447 11.875 6.25 11.875Z",
      stroke: "currentColor",
      strokeLinecap: "round",
      strokeLinejoin: "round"
    }
  ...
  [
    "path",
    {
      d: "M13.75 11.875C14.7856 11.875 15.625 11.0356 15.625 10C15.625 8.96444 14.7856 8.125 13.75 8.125C12.7144 8.125 11.875 8.96444 11.875 10C11.875 11.0356 12.7144 11.875 13.75 11.875Z",
      stroke: "currentColor",
      strokeLinecap: "round",
      strokeLinejoin: "round"
    }
