...
export const DiceFive = createIcon("dice-five", [
  ...
  [
    "path",
    {
      d: "M11.5 21.75C12.1904 21.75 12.75 21.1904 12.75 20.5C12.75 19.8096 12.1904 19.25 11.5 19.25C10.8096 19.25 10.25 19.8096 10.25 20.5C10.25 21.1904 10.8096 21.75 11.5 21.75Z",
      fill: "currentColor",
      stroke: "none"
    }
  ],
